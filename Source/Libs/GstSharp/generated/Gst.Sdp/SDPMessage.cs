...
#region Autogenerated code
	...
	public partial struct SDPMessage : IEquatable<SDPMessage> {
		...
		{
			return true && Version.Equals (other.Version) && Origin.Equals (other.Origin) && SessionName.Equals (other.SessionName) && Information.Equals (other.Information) && Uri.Equals (other.Uri) && Emails.Equals (other.Emails) && Phones.Equals (other.Phones) && Connection.Equals (other.Connection) && Bandwidths.Equals (other.Bandwidths) && Times.Equals (other.Times) && Zones.Equals (other.Zones) && Key.Equals (other.Key) && Attributes.Equals (other.Attributes) && Medias.Equals (other.Medias);
		}
		...
		{
			return this.GetType ().FullName.GetHashCode () ^ Version.GetHashCode () ^ Origin.GetHashCode () ^ SessionName.GetHashCode () ^ Information.GetHashCode () ^ Uri.GetHashCode () ^ Emails.GetHashCode () ^ Phones.GetHashCode () ^ Connection.GetHashCode () ^ Bandwidths.GetHashCode () ^ Times.GetHashCode () ^ Zones.GetHashCode () ^ Key.GetHashCode () ^ Attributes.GetHashCode () ^ Medias.GetHashCode ();
		}
