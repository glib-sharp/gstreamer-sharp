...
#region Autogenerated code
	public partial class Global {
		...
		public static Gst.Caps CodecUtilsOpusCreateCaps(uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count) {
			return CodecUtilsOpusCreateCaps (rate, channels, channel_mapping_family, stream_count, coupled_count, 0);
		}
		...
		public static Gst.Buffer CodecUtilsOpusCreateHeader(uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count, ushort pre_skip, short output_gain) {
			return CodecUtilsOpusCreateHeader (rate, channels, channel_mapping_family, stream_count, coupled_count, 0, pre_skip, output_gain);
		}

		[DllImport("libgstpbutils-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool gst_codec_utils_opus_parse_caps(IntPtr caps, uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count, byte channel_mapping);

		public static bool CodecUtilsOpusParseCaps(Gst.Caps caps, uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count, byte channel_mapping) {
			bool raw_ret = gst_codec_utils_opus_parse_caps(caps == null ? IntPtr.Zero : caps.Handle, rate, channels, channel_mapping_family, stream_count, coupled_count, channel_mapping);
			bool ret = raw_ret;
			return ret;
		}

		[DllImport("libgstpbutils-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool gst_codec_utils_opus_parse_header(IntPtr header, uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count, byte channel_mapping, ushort pre_skip, short output_gain);

		public static bool CodecUtilsOpusParseHeader(Gst.Buffer header, uint rate, byte channels, byte channel_mapping_family, byte stream_count, byte coupled_count, byte channel_mapping, ushort pre_skip, short output_gain) {
			bool raw_ret = gst_codec_utils_opus_parse_header(header == null ? IntPtr.Zero : header.Handle, rate, channels, channel_mapping_family, stream_count, coupled_count, channel_mapping, pre_skip, output_gain);
			bool ret = raw_ret;
			return ret;
		}
