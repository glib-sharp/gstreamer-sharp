...
#region Autogenerated code
	public partial class RTSPConnection : GLib.Opaque {
		...
		public Gst.Rtsp.RTSPResult ConnectWithResponse(IntPtr timeout, Gst.Rtsp.RTSPMessage response) {
			int raw_ret = gst_rtsp_connection_connect_with_response(Handle, timeout, response == null ? IntPtr.Zero : response.Handle);
			Gst.Rtsp.RTSPResult ret = (Gst.Rtsp.RTSPResult) raw_ret;
			return ret;
		}
		...
		public Gst.Rtsp.RTSPResult Receive(Gst.Rtsp.RTSPMessage message, IntPtr timeout) {
			int raw_ret = gst_rtsp_connection_receive(Handle, message == null ? IntPtr.Zero : message.Handle, timeout);
			Gst.Rtsp.RTSPResult ret = (Gst.Rtsp.RTSPResult) raw_ret;
			return ret;
		}
		...
		public Gst.Rtsp.RTSPResult Send(Gst.Rtsp.RTSPMessage message, IntPtr timeout) {
			int raw_ret = gst_rtsp_connection_send(Handle, message == null ? IntPtr.Zero : message.Handle, timeout);
			Gst.Rtsp.RTSPResult ret = (Gst.Rtsp.RTSPResult) raw_ret;
			return ret;
		}
